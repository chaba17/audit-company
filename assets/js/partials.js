/* ==========================================================
   Shared Header + Footer — EY-inspired
   ========================================================== */
...
const ICONS = {
  ...
  "facebook":      '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M22 12a10 10 0 1 0-11.56 9.88v-6.99H7.9V12h2.54V9.8c0-2.5 1.49-3.89 3.77-3.89 1.09 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56V12h2.77l-.44 2.89h-2.33v6.99A10 10 0 0 0 22 12z"/></svg>',
    ...
    <div class="announcement">
      <div class="container">
        <div class="announcement-inner">
          <span>▸ ახალი: 2026 წლის საგადასახადო ცვლილებების ანგარიშგება ხელმისაწვდომია</span>
          <a href="${basePath}blog.html">წაიკითხე ანგარიში →</a>
        </div>
      </div>
    </div>
  `;
...
function renderHeader() {
  const dropdownItems = SERVICES.map((s, i) => `
    <a href="${basePath}services/${s.slug}.html">
      <span class="dropdown-num">0${i + 1}</span>
      <span class="dropdown-text">
        <strong data-i18n="${s.key}.title"></strong>
        <span data-i18n="${s.key}.desc"></span>
      </span>
    </a>
  `).join("");
      ...
      <div class="container-wide">
        <nav class="nav" aria-label="Main">
          <a href="${basePath}index.html" class="logo">
            ...
            <span class="logo-tagline">საბუღალტრო და<br>საგადასახადო სერვისები</span>
          </a>
          ...
          <ul class="nav-menu">
            ...
            <li><a href="${basePath}services.html">ინდუსტრიები</a></li>
            <li><a href="${basePath}blog.html">Insights</a></li>
            <li><a href="${basePath}pricing.html" data-i18n="nav.pricing"></a></li>
            <li><a href="${basePath}about.html" data-i18n="nav.about"></a></li>
            <li><a href="${basePath}contact.html" data-i18n="nav.contact"></a></li>
          </ul>
          ...
          <div class="nav-actions">
            ...
            <a href="${basePath}contact.html" class="btn btn-yellow btn-sm">
              მიიღე კონსულტაცია ${ICONS["arrow-right-sm"]}
            </a>
